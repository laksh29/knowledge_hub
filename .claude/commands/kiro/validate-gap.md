...
1. **Load Context**:
   ...
   - Read `flutter-clean-architecture-guide.md` (repo root) — the project's binding Flutter Clean Architecture & TDD standard, used to judge whether existing code already complies (layering, type safety, naming) or represents debt to flag
