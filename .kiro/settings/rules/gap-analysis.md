...
- Extract conventions:
  ...
  - Type-safety compliance: flag existing `dynamic`, `Object?`-as-type, or cross-layer `Map<String, dynamic>` usage as technical debt to note (not silently propagate into new work)
